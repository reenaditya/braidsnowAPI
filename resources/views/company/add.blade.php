		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('name') is-invalid @enderror" id="inputSuccess1" name="name" value="{{ old('name') }}">
					@error('name')
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('phone') is-invalid @enderror" id="mobile_number" name="phone" value="{{ old('phone') }}">
					@error('phone')
					<div class="invalid-feedback">{{ $message }}</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group validated">
					...
					<input type="url" class="form-control @error('website') is-invalid @enderror" id="wensite" name="website" value="{{ old('website') }}">
					@error('website')
					<div class="invalid-feedback">{{ $message }}</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group validated">
					...
					<input type="number" class="form-control @error('state_code') is-invalid @enderror" id="state_code" name="state_code" value="{{ old('state_code') }}">
					@error('state_code')
					<div class="invalid-feedback">{{ $message }}</div>
			...
			<div class="col-md-4">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('pan_card') is-invalid @enderror" id="pan_card" name="pan_card" value="{{ old('pan_card') }}" >
					@error('pan_card')
					<div class="invalid-feedback">{{ $message }}</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group validated">
					...
					<textarea  class="form-control @error('note') is-invalid @enderror"id="note" name="note" cols="30" rows="5">{{ old('note') }}</textarea>
