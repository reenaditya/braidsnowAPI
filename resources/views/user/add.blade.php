		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('display_name') is-invalid @enderror"  name="display_name" value="{{ old('display_name') }}">
					@error('display_name')
					<div class="invalid-feedback">{{ $message }}</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group validated">
					...
					<textarea name="address" class="form-control @error('address') is-invalid @enderror" cols="30" rows="5"></textarea>
					@error('address')
					<div class="invalid-feedback">{{ $message }}</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('zip_code') is-invalid @enderror"  name="zip_code" value="{{ old('zip_code') }}">
					@error('zip_code')
					<div class="invalid-feedback">{{ $message }}</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('alternate_mobile_number') is-invalid @enderror"  name="alternate_mobile_number" value="{{ old('alternate_mobile_number') }}">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('gst_no') is-invalid @enderror" name="gst_no" value="{{ old('gst_no') }}">
					@error('gst_no')
					<div class="invalid-feedback">{{ $message }}</div>
			...
			<div class="col-md-4">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('state_code') is-invalid @enderror"  name="state_code" value="{{ old('state_code') }}">
					@error('state_code')
					<div class="invalid-feedback">{{ $message }}</div>
			...
			<div class="col-md-4">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('pancard') is-invalid @enderror"  name="pancard" value="{{ old('pancard') }}">
					@error('district')
					<div class="invalid-feedback">{{ $message }}</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('shipping_address') is-invalid @enderror" name="shipping_address" value="{{ old('shipping_address') }}">
			...
			<div class="col-md-6">
				<div class="form-group validated">
					...
					<input type="text" class="form-control @error('shipping_mobile') is-invalid @enderror" name="shipping_mobile" value="{{ old('shipping_mobile') }}">
